################################################################################
### Heranalyse Toetsanalyse 3 versies stap 1.R
################################################################################
...
teleformdata_onbekend <- teleformdata %>% dplyr:: filter(Toetsversie >3)
...
teleformdata_correct <- rbind(teleformdataA, teleformdataB_correct, teleformdataC_correct)
